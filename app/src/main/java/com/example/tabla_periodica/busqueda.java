...
//1-45
            ...
            {"Azufre","es un no metal de color amarillo pálido y olor desagradable, que se encuentra en la naturaleza tanto en forma libre como combinado con otros elementos; se usa para la obtención de ácido sulfúrico, para fabricar fósforos, caucho vulcanizado, tintes, pólvora, fungicidas, en fotografía para el fijado de negativos y positivos, y, en medicina para la elaboración de sulfamidas y pomadas tópicas.","S","VIA","S","32.065(g/mol)","16","16","16","-2,+2,+4,+6"},
            ...
            {"Calcio"," Los compuestos de calcio constituyen 3.64% de la corteza terrestre. ... Al igual que el berilio y el aluminio, pero a diferencia de los metales alcalinos, no causa quemaduras sobre la piel.","Ca","IIA","p","40.078(g/mol)","20","20","20","+2"},
...
//
            {"Torio","Es uno de los 2 elementos significativamente radioactivos que aún ocurren naturalmente en grandes cantidades como elemento primordial, el otro es el Uranio.","Th","-","-","232.0380(g/mol)","90","90","142","+4"},
            ...
            {"Flerovio"," Elemento químico relativamente nuevo, cuyo descubrimiento se atribuye a los rusos. ","Fl","7","p","276g/mol","114","--","165","4,6,4,2"},

            {"Moscovio","es un combustible magnifico ya que no es de este planeta, ya que fue encontrado en naves extraterrestre","Mc","7","p","279g/mol","115","--","166","5,4,5,1"},

            {"Livermorio","El Nectarien es un elemento químico que no está aprobado oficialmente por la IUPAC y que no tiene una fecha determinada de su descubrimiento.","Lv","7","p","282g/mol","116","--","167","5,4,5,3"},

            {"Teneso","Este nuevo elemento químico fue creado al hacer colisionar isótopos de calcio","Ts","7","p","285g/mol","117","--","168","2,3,2,1"},

            {"Oganeson","El oberón o ununoctio (conocido anteriormente como eka-radón); nombre sistemático temporal dado por la Unión Internacional de Química Pura y Aplicada al elemento sintético transactínido","Og","7","p","288g/mol","118","--","169","4,7"}

    };
    int[] datosImg = {R.drawable.e_1, R.drawable.e_2, R.drawable.e_3,
            ...
            R.drawable.laurencio,R.drawable.ruthefordio,R.drawable.dubnio,R.drawable.bismuto,R.drawable.bohrio,R.drawable.hassio,
...
lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent visor=new Intent(view.getContext(),prueba.class);
                visor.putExtra("TIT",elementos[position][0]);
                visor.putExtra("DET",elementos[position][4]);
                pos=position;
                startActivity(visor);
            }
        });
